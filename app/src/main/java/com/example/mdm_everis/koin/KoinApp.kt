...
class KoinApp {
    ...
    val appModule by lazy {
        module {
            ...
            viewModel { ReservesViewModel(androidApplication(),get(),get(),get(),get()) }
            ...
            viewModel { ProfileViewModel(androidApplication(),get(),get(),get(),get()) }
            viewModel { DeviceDetailsViewModel(androidApplication(),get(),get(),get(),get()) }
            viewModel { ReserveProcessViewModel(androidApplication(),get(),get(),get(),get(),get()) }
        }
    }
}